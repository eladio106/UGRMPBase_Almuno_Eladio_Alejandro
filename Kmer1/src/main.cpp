 ...
 *
 *@author Eladio Carbonell Rodríguez
 *@author Alejandro Illeras Liñan
...
int main(int argc, char* argv[]) {
    ...
    //      in the array kmers
    ReadArrayKmerFreq(kmers, num, nKmers);
    // Normalizes each kmer in the array kmers
    for(int i=0; i<nKmers; i++){
        NormalizeArrayKmerFreq(kmers[i], nKmers, VALID_NUCLEOTIDES);
    }
